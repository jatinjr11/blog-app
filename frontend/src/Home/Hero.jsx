...
const Hero = () => {
  ...
  return (
    <div className='container  mx-auto py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pl-32 pr-32 animate-fadeInUp text-black dark:bg-gray-900 dark:text-white px-72'>
